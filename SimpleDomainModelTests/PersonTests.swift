...
class FamilyTests : XCTestCase {
  ...
  func testFamilyWithKids() {
    ...
    // New unit tests for domain-modeling v2
    XCTAssert(ted.description == "Ted Neward, age: 45, job: Guest Lecturer, Salary(1000), spouse: Charlotte")
    XCTAssert(family.description == "Ted Neward, age: 45, job: Guest Lecturer, Salary(1000), spouse: Charlotte" + "\n" + "Charlotte Neward, age: 45, spouse: Ted" + "\n" + "Mike Neward, age: 22, job: Burger-Flipper, Hourly(5.5)" + "\n" + "Matt Neward, age: 16")
  }  
}